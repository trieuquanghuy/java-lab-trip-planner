// Source: 01-RESEARCH.md Pattern 4 (lines 547-663, especially companion ServletSecurityConfig at lines 644-663) (mirror of trip-service version per 01-PATTERNS.md Bucket D 'identical config text');
