// Source: 02-PATTERNS.md §RestAuthenticationEntryPoint EXACT match (verbatim copy of
//         services/trip-service/.../security/RestAuthenticationEntryPoint.java with package rename).
...
// SecurityContext) but Spring Security's authorize-step then rejects it. For Phase 2 the residual case is
