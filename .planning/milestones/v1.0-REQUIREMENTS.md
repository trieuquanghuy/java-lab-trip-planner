# Requirements Archive: v1.0 Trip Planner MVP
...
- [x] **NFR-09**: All inter-service requests carry W3C trace context; structured JSON logs include `traceId`, `spanId`, `userId`, `requestId`. Single end-to-end trace visible in Zipkin. *(maps to PRD NFR-9)* **[Phase 10: MDC enrichment + trace-verify.sh]**
